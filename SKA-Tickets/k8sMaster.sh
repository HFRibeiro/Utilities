#!/bin/bash
#/* **************** LFD459:1.18.1 s_02/k8sMaster.sh **************** */
#/*
...
sudo apt-get install -y kubeadm=1.18.2-00 kubelet=1.18.2-00 kubectl=1.18.2-00
...
sudo kubeadm init --kubernetes-version 1.18.2 --pod-network-cidr 192.168.0.0/16
