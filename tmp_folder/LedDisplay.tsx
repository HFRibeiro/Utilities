...
function Led(props) {
  ...
  const styleLED: CSSProperties = {height: pxSize, width: pxSize, borderRadius: pxSize, marginLeft: marginLED, marginTop: marginLEDTOP};
...
class LedReadOnly extends Component<Props> {
  public render() {
    ...
    const fontSizeC = actualWidth/10;

    const value = this.checkCondition();
    const style: CSSProperties = {height: "30px",padding: "0.3em", whiteSpace: "nowrap", fontSize: fontSizeC};
